...
import com.zhumeng.common.Constant;
import com.zhumeng.enums.ResourceType;
import com.zhumeng.exception.BusinessException;
...
import com.zhumeng.modules.sys.mapper.PermissionMapper;
...
public class PermissionServiceImpl extends ServiceImpl<PermissionMapper, Permission> implements IPermissionService {
    ...
    public Boolean delBatchPermission(List<Integer> ids) {
        ...
        if(ids.size() == 1){
            ...
            List<Permission> list = this.baseMapper.selectList(new EntityWrapper<Permission>(con));
