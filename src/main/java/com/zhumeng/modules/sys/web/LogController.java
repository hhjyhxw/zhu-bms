...
public class LogController extends BaseController {
    ...
    public @ResponseBody
        ...
        EntityWrapper<Log> wrapper = new EntityWrapper<Log>(log);
        ...
        Page<Log> pageObj = ilogService.selectPage(new Page<Log>(page,limit), wrapper);
        return new ResultInfo<List<Log>>(pageObj.getRecords(), pageObj.getTotal());
    }
